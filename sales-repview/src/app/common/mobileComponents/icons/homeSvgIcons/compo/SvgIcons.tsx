...
export default function RouteSvgIcone() {
  return (
    <svg
      width="112"
      height="144"
      ...
      <defs>
        ...
        <clipPath id="clip0_3222_113">
          <rect
            ...
            height="150"
            fill="white"
            transform="translate(1.52588e-05 -3)"
          />
        </clipPath>
