...
import { TOKEN_DATA } from './core/constante';
...
export function middleware(request: NextRequest) {
  ...
  console.log('token:', !request.cookies.get(TOKEN_DATA));
  ...
  if (
    !request.cookies.get(TOKEN_DATA) &&
  ...
  if (request.cookies.get(TOKEN_DATA) && publicPaths.includes(pathname)) {
