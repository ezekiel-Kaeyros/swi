...
var pos_1 = require("../db/pos");
var mongoose_1 = __importDefault(require("mongoose"));
var PosController = {
    getPos: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        var pos, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, pos_1.findAllPos)()];
                case 1:
                    pos = _a.sent();
                    response.send(pos);
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching all pos:', error_1.message);
    ...
    getOnePos: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        var id, pos, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, pos_1.findOnePos)(id)];
                case 1:
                    pos = _a.sent();
                    if (pos) {
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error('Error fetching one pos:', error_2.message);
    ...
    updatePos: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    error_4 = _b.sent();
                    console.error('Error updating pos:', error_4.message);
                    response.status(500).json({ success: false, error: 'Internal Server Error' });
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
    ...
    deletePos: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        var id, deletedPos, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    ...
                    return [4 /*yield*/, (0, pos_1.deletePos)(id)];
                case 1:
                    deletedPos = _a.sent();
                    if (deletedPos) {
