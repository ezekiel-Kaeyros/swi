...
var TaskController = {
    getTask: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        var task, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, task_1.findAllTask)()];
                case 1:
                    task = _a.sent();
                    response.send(task);
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching all task:', error_1.message);
    ...
    getOneTask: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        var id, task, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, task_1.findOneTask)(id)];
                case 1:
                    task = _a.sent();
                    if (task) {
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error('Error fetching one task:', error_2.message);
    ...
    saveTask: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, task_1.createTask)({ title: title, description: description })];
                case 1:
                    newTask = _b.sent();
                ...
                case 2:
                    error_3 = _b.sent();
                    console.error('Error creating Task:', error_3.message);
                    response.status(500).json({ success: false, error: 'Internal Server Error' });
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, task_1.updateTask)({ id: id, title: title, description: description })];
                case 1:
                    updatedTask = _b.sent();
                    if (updatedTask) {
                ...
                case 2:
                    error_4 = _b.sent();
                    console.error('Error updating task:', error_4.message);
                    response.status(500).json({ success: false, error: 'Internal Server Error' });
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
    ...
    deleteTask: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, task_1.deleteTask)(id)];
                case 1:
                    deletedTask = _a.sent();
                    if (deletedTask) {
