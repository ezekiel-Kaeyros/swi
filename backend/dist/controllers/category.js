...
var CategoryController = {
    getCategory: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        var category, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, db_1.findAllCategory)()];
                case 1:
                    category = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching all category', error_1.message);
    ...
    getOneCategory: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, db_1.findCategoryById)(id)];
                case 1:
                    category = _a.sent();
                    if (category) {
    ...
    saveCategory: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    error_3 = _b.sent();
                    console.error('Error creating category:', error_3.message);
    ...
    deleteCategory: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, db_1.deleteCategory)(id)];
                case 1:
                    category = _a.sent();
                    if (category) {
                        response.json({ success: true, data: category });
