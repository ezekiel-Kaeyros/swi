...
var activities_1 = require("../db/activities");
var ActivitiesController = {
    getActivities: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        var Activities, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, activities_1.findAllActivities)()];
                case 1:
                    Activities = _a.sent();
    ...
    getOneActivities: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, activities_1.findActivityById)(id)];
                case 1:
                    activitie = _a.sent();
                    if (activitie) {
    ...
    saveActivities: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        var activitie, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, activities_1.createActivity)(request.body)];
                case 1:
                    activitie = _a.sent();
    ...
    updateActivitie: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, activities_1.updateActivity)(data)];
                case 1:
    ...
    deleteActivity: function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, activities_1.deleteActivity)(id)];
                case 1:
