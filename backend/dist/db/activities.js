...
var findAllActivities = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                console.log('Error finding all activities ', error_1.message);
                throw error_1;
...
var findActivityById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
...
var createActivity = function (activityData) { return __awaiter(void 0, void 0, void 0, function () {
    var activity, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, models_1.Activities.create(activityData)];
            case 1:
                activity = _a.sent();
                return [2 /*return*/, activity];
            case 2:
...
var updateActivity = function (activityData) { return __awaiter(void 0, void 0, void 0, function () {
    var updateActivity_1, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 1:
                ...
                return [2 /*return*/, updateActivity_1];
            case 2:
                error_4 = _a.sent();
