...
var getRoleById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                query = { _id: id };
                return [4 /*yield*/, models_1.Role.findOne(query)];
            case 1:
                role = _a.sent();
...
var getRoles = function () { return __awaiter(void 0, void 0, void 0, function () {
    var roles;
    return __generator(this, function (_a) {
        roles = models_1.Role.find({});
        return [2 /*return*/, roles];
    });
}); };
exports.getRoles = getRoles;
var addRoleUser = function (name) { return __awaiter(void 0, void 0, void 0, function () {
    var role;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, models_1.Role.create({
                    name: name,
                })];
            case 1:
                role = _a.sent();
