...
const SettingsModule = () => {
  ...
  return (
    <div className="p-[4rem] h-[calc(100vh-50px)] font-articulat bg-optionContainerBg">
      <SettingsNavigation />
      ...
      <div className="mt-10">
        ...
        {channelCluster.status && <ChannelCluster />}
        ...
        {roleAndModel.status && <>Role & Model {/* COMING SOON */}</>}
