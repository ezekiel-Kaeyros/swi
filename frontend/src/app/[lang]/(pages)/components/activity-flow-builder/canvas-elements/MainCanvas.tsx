...
const MainCanvas = ({ toggle }: any) => {
  ...
  const { 
    connectTwoNodes, deleteAndEdge, locaChannelClusters, 
    locaTradeChannels, tradeChannels, localCategories, 
    edgesConnectingNodes, activities, channelClusters 
  } = useSettings(); 
  ...
  useEffect (() => {
    setNodes ([
      ...removeDuplicates(locaChannelClusters as []) , 
      ...removeDuplicates(locaTradeChannels as any), 
      ...removeDuplicates(localCategories as any), 
      ...removeDuplicates(localActivities as any)
    ])
  }, [
    locaChannelClusters, locaTradeChannels, 
    localCategories, localActivities
  ])
  ...
  return (
    <>
      ...
      <div className='relative' style={{ width: toggle ? '100vw' : '60vw', height: '85vh', zIndex: 100 }}>
        ...
        {/* END THE FLOW BUILDER CORE */}

        {/* CHANNEL CLUSTER MODAL */}
        <CustomModal
