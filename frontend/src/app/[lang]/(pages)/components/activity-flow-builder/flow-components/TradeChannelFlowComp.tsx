...
import { copyLocalTradeChannel, deleteLocalTradeChannel } from '@/redux/features/channel-cluster-slice'
  ...
  return (
        <>
            <div className='big-parent relative bg-newPrimaryDark rounded-xl p-5 flex flex-col w-[300px]'>
                ...
                <div key={ data.id } className=' bg-tranparent rounded-xl flex flex-col gap-3'>
                    <div className='flex flex-row justify-between' >
                        <div className='flex flex-row items-center justify-center gap-3'>
                            <div className='bg-channelTradeMarkerBgColor p-2 rounded-xl'>
                                <svg width="20" height="20" viewBox="0 0 16 16" fill={ data?.color as any } xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className='flex flex-col'>
                                ...
                                <span className='text-slate-300 text-[14px]'>{ data?.name }</span>
                            </div>
                        </div>
                        <div className='cursor-pointer mt-[.5rem]'>
                            <svg width="25" height="25" viewBox="0 0 12 12" fill={ data?.color as any } xmlns="http://www.w3.org/2000/svg">
