  ...
  return (
    <div className="flex flex-col justify-around absolute w-[480px] h-[236px] bg-newPrimaryDark text-white z-20 rounded-2xl p-[1rem]">
      <div className="flex flex-col justify-between gap-3">
        <GenericPopupHeader
          label={'Canceling Creation'}
          closeCanceModal={closeCanceModal}
          closeIconIcon={closeIconIcon}
        />
        <div>
          <p>
            You have not yet finished creating an agent. The information will
            not be saved if you exit now
          </p>
        </div>
      </div>
      <div className="flex justify-end gap-9 ">
        ...
        <div>
          <Button
            className={`rounded-xl bg-keepEditingBtnBg h-[48px] w-[167px] flex justify-center font-bold `}
            onClick={closeAgentCreationModal}
          >
            Cancel Editing
          </Button>
        </div>
