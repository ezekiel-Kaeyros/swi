...
const ReactTimeTrackingModules = () => {
  ...
  return (
    <div className='px-[1rem] py-[2rem]'>
        <GenericNavigation settingPageNavigation={ realTimeTrackingNavigationList } genericAction={ selectNavigationTabsInRTT } settinPStyle={ false } genericActionBoolean={ true } agentDStyle={ false } />
