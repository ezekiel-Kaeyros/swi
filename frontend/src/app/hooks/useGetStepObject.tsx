...
import { AgentFormValueMainTypeMain, AgentFormValueType, IFormStep, IFormSteps } from '@/redux/features/types';
...
const useGetStepObject = () => {
    ...
    const currentSalesRepsAgent: AgentFormValueMainTypeMain = useSelector(
        (state: RootState) => state.AgentCreationReducer.currentSalesRepsAgent!
    );
